...
export const ImageCarousel: React.FC<ImageCarouselProps> = ({ images, onImageClick }) => {
  ...
  return (
    <div className="relative w-full rounded-lg overflow-hidden bg-slate-100/60 dark:bg-slate-900/40 my-3 select-none">
      ...
      <div className="px-5 py-2.5 bg-slate-100 dark:bg-slate-950 flex flex-col sm:flex-row items-center justify-between gap-2 font-mono text-xs text-slate-600 dark:text-slate-400">
